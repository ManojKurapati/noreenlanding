  ...
  return (
    <section className="py-24 bg-slate-950/40 border-t border-slate-900 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-slate-900 to-slate-950 border border-slate-900 rounded-3xl p-8 lg:p-12 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-5 space-y-4">
              <span className="text-xs font-semibold uppercase tracking-widest text-teal-400 block">
              ...
              <div className="pt-2 text-xs font-semibold text-slate-300 border-l-2 border-teal-500 pl-4">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {steps.map((step, idx) => {
                ...
                return (
                  <div 
                    key={idx} 
                    className="flex gap-3 bg-slate-900/60 border border-slate-800/40 rounded-2xl p-4 hover:border-slate-800 transition-colors"
                  >
