      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <div className="bg-slate-900/40 border border-slate-900 rounded-3xl p-8 relative overflow-hidden">
              {isSuccess ? (
                <div className="text-center py-12 space-y-4 animate-in fade-in duration-300">
                  ...
                  <h3 className="text-2xl font-bold text-slate-100">Consultation Scheduled!</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <h3 className="text-xl font-bold text-slate-200 mb-2">Schedule a Consultation</h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full bg-slate-950 border ${errors.name ? "border-rose-500" : "border-slate-800 focus:border-teal-500"} rounded-xl px-4 py-3 text-slate-100 text-sm focus:outline-none transition-colors`}
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full bg-slate-950 border ${errors.email ? "border-rose-500" : "border-slate-800 focus:border-teal-500"} rounded-xl px-4 py-3 text-slate-100 text-sm focus:outline-none transition-colors`}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="company" className="text-xs font-semibold text-slate-400 uppercase tracking-wider block">
                        Company Name
                      </label>
                      <input
                        type="text"
                        ...
                        onChange={handleInputChange}
                        className="w-full bg-slate-950 border border-slate-800 focus:border-teal-500 rounded-xl px-4 py-3 text-slate-100 text-sm focus:outline-none transition-colors"
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full bg-slate-950 border ${errors.service ? "border-rose-500" : "border-slate-800 focus:border-teal-500"} rounded-xl px-4 py-3 text-slate-300 text-sm focus:outline-none transition-colors`}
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows={5}
                      className={`w-full bg-slate-950 border ${errors.message ? "border-rose-500" : "border-slate-800 focus:border-teal-500"} rounded-xl px-4 py-3 text-slate-100 text-sm focus:outline-none transition-colors resize-none`}
                  ...
                  <div className="pt-2">
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 font-bold py-3.5 rounded-xl shadow-lg border-none flex items-center justify-center gap-2"
                    >
